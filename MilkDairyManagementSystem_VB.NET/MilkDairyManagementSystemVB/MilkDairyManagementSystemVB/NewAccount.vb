...
Public Class NewAccount
    ...
    Private Sub button1_Click(sender As Object, e As EventArgs) Handles button1.Click
        con = New SqlConnection("Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\HP\Downloads\kashipara.com_milk-dairy-management-syst\MilkDairyManagementSystem_VB.NET\MilkDairyManagementSystemVB\MilkDairyManagementSystemVB\dairy.mdf;Integrated Security=True")
        con.Open()
    ...
    Private Sub NewAccount_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        con = New SqlConnection("Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\milk-dairy-management-syst\MilkDairyManagementSystem_VB.NET\MilkDairyManagementSystemVB\MilkDairyManagementSystemVB\dairy.mdf;Integrated Security=True")
        con.Open()
        Try
        ...
        Catch ex As Exception
            MsgBox(ex.ToString)
        End Try
        Using con = New SqlConnection("Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\milk-dairy-management-syst\MilkDairyManagementSystem_VB.NET\MilkDairyManagementSystemVB\MilkDairyManagementSystemVB\dairy.mdf;Integrated Security=True")
